...
fn main_vs_ground(@location(0) inPos: vec3f, @location(3) texCoord: vec2f) -> VSOutGround {
    ...
    // Ground model matrix is identity, so raw position is world position
